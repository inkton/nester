...
class App(Cloud):
    ...
    def create_owner(self):
        ...
        #self.os_exec_shell("echo "+os.environ['NEST_TREE_KEY']+" | base64 --decode > /home/"+os.environ['NEST_CONTACT_ID']+"/.ssh/known_hosts")
        ...
        self.os_exec_shell("ssh-keyscan -H "+os.environ['NEST_APP_TAG']+".nestapp.yt > ~/.ssh/known_hosts")
